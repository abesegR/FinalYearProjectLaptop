    ...
    <>
      <style>{`
        ...
        *{margin:0;padding:0;box-sizing:border-box;}
        ...
        .auth-root{height:100vh;display:flex;align-items:center;justify-content:center;opacity:0;transform:translateY(12px);transition:opacity 0.45s ease,transform 0.45s ease;position:relative;overflow-y:auto;}
        .auth-root.visible{opacity:1;transform:translateY(0);}
        .auth-root.leaving{opacity:0;transform:translateY(-12px);}
        .auth-card{width:100%;max-width:420px;background:rgba(23,31,51,0.5);backdrop-filter:blur(24px);border:1px solid rgba(255,255,255,0.1);border-radius:24px;padding:2.5rem;box-shadow:0 8px 32px rgba(0,0,0,0.4);position:relative;z-index:1;margin:2rem 1rem;}
      ...
      >
        <div className="auth-card">
          ...
          >
            ...
            <button className="auth-link" onClick={() => goTo("/login")}>
              Sign in
            </button>
          </div>
